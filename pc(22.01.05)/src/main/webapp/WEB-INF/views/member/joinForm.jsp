...
<body>
	<div class="container" align="center">
		<div>회원가입</div>
	<form action="join.do" method="post" name="frm" onsubmit="return chk()" enctype="multipart/form-data">
		...
		<input type="hidden" name="emailchk" value="0">
			...
			<div>
				...
				<input type="button" onclick="chk2()" value="중복체크">
			</div>
			<div id="err"></div>
			<div>암호</div>
			<div>
			...
			<div>닉네임</div>
			<div>
				<input type="text" name="nick_name" required="required">
